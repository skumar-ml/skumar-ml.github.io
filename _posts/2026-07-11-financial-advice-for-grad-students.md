...
An individual brokerage account is the most basic way to invest (this is the default account you open with any brokerage). The money invested in this account has already been taxed (what we call *post-tax* money). If your investments grow (e.g., from 10k to 30k) and you sell those investments, you need to pay *capital gains tax* on the earned 20k, and the capital gains tax can be significant{% include academic-project/footnote.html text="Currently, the federal long-term capital gains tax is at 15%, and most states tax capital gains as regular income (in California, that could be up to an additional 13%!)." %}.
